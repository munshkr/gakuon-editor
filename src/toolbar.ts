 ...
 */
const TOOLBAR_ITEM = 'Toolbar-item';

/**
 * The class name added to document toolbar buttons.
 */
const TOOLBAR_BUTTON = 'Toolbar-button';

/**
 * The class name added to a pressed button.
 */
const TOOLBAR_PRESSED = 'mod-pressed';
...
namespace Private {
   ...
   */
  export
  const nameProperty = new Property<Widget, string>({ name: 'name' });
